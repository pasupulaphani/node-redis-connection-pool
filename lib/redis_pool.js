 ...
 * @property {String}   options.name - Name your pool
 * @property {String}   options.redisOptions - opts from [node_redis#options-object-properties]{@link https://github.com/NodeRedis/node_redis#options-object-properties}
 * @property {String}   options.poolOptions - opts from [node-pool#createpool]{@link https://github.com/coopernurse/node-pool#createpool}
 * @property {Object}   options.logger - Inject your custom logger
 */
